...
4. `/moments` is the pack page (not inside the photo form). It says what this is and what it is not, then **40 good moments — $29**. There is no checkout yet. **Start hunting — $29** opens `/app`. The photo page header **Start hunting** returns to `/moments`.
