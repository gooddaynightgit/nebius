...
2. **0:20** Landing arrow opens the joy accordion. Pick one quiet joy — the accordion stays open, and the photo arrow opens `/app`. Heading is **Today. One good moment. Go get it.** Upload one photo (screenshots count; a video can yield one still). The photo spark appears, and the caption asks **What is the good in this moment?** (≤80). **Save today's moment** — then **YOURS** appears. Tap it to open `/app/yours`.
