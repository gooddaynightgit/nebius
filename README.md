...
Checkout signing follows the same field order as the Longevity Greenlight / whycantisleep handler (`lambda_api/checkout.py`). The ITN signature follows Payfast’s notify sample, not that checkout string:
