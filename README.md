...
3. Private vault only — not shared, posted, or used to train public models. The buyer email and code stay on the photo page when that gate is closed. Opening the story does not ask again.
