...
2. **0:20** `/app`. Heading is **Today. One good moment. Go get it.** Upload one photo (screenshots count; a video can yield one still), caption **What’s the good in this one?** (≤80), pick a quiet-joy radio. **Save today's moment** — then **YOURS** appears. Tap it to open `/app/yours`.
