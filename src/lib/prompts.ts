...
5. Do not write the closing line. The app adds one closing line after a blank line, and it does not count toward the 25 to 45 words. Stop when the weaving story is done.
